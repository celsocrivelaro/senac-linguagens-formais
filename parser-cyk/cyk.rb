...
class CYKParser
  ...
  def adiciona_terminais(entrada)
    # cria uma lista de listas do tamanho da entrada
    lista_simbolos = Array.new(entrada.length) { [] }
    # Usa os símbolos de entrada 'string' e converte para uma lista de símbolos
    lista_simbolos_entrada = entrada.split('')

    # Coloca os símbolos terminal em diagonal
