...
2.	**Implementar um algoritmo** que percorra a entrada e converta corretamente o valor para valores numéricos
...
**Simplificações**
- Nosso tradutor deve reconhecer números até 3999

# O que será avaliado:

### Modelagem do Transdutor - Documentação
...
Faça o modelo de transição de estados usando Mermaid. Envie o código fonte do mermaid usado no repositório dentro do diretório /docs na raíz do projeto.
...
**Não será permitido** 
- Uso de gems ou bibliotecas de estado de finito. 
- Use tabelas ou hash, só transições de estado.
- Cálculos para a geração da saída. A emissão de símbolos deve ser feita unicamente por transição de estados.

**O que é obrigatório**
- O usuário deverá entrar com os valores para a tradução pelo teclado.
- Deve indicar como ACEITA ou REJEITADA a cadeia de entrada.
- Deve exibir o resultado final em valores numéricos.
